...
function success(pos){
    ...
    //   google.maps.event.addListener(allMarkers, 'click', (function(allMarkers, i) {
    //     return function() {
    //       infowindow.setContent(allLocations[i]['name']);
    //       infowindow.open(googleMap, allMarkers);
    //     }
    //   })(allMarkers, i));       
